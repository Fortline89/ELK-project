...
- Go to <a href=”http://[ELK-VM-PUBLIC-IP]:5601/app/Kibana” >Kibana</a> to check that the ELK server is running. Verify that elk is receiving logs from both Web1 and Web2 like this:
